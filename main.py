...
if __name__ == "__main__":
	...
	search_queries = ["cat videos", "cats"]
	results_to_add = []
	...
	# sorry for the nested for loops but ok this goes through the search queries
	for search_query in search_queries:
		for i in range(1, 50):  # just change this value for how many pages to run
	...
	# TODO add try except block for the HttpError 403 that comes up when you exceed quota
	# couldn't test this bc i exceeded my quota already
